// =====================================================================================
// LoRaReceiverMQTT (code3) - V1.5 (Blocking-Fehler behoben)
// -------------------------------------------------------------------------------------
// Letzte Änderung: 2. Juli 2025 (Verarbeitung der Nachrichten-Queue nicht-blockierend gemacht)
// Hardware:        ESP32 DevKitC (oder ähnlicher ESP32 mit LoRa-Modul)
// Funktion:        Empfängt LoRa-Daten und kann nun via MQTT den Befehl zum Schließen
//                  des Garagentors empfangen. Überwacht, ob der Befehl erfolgreich war
//                  und sendet bei einem Fehler eine ntfy-Benachrichtigung.
// =====================================================================================
